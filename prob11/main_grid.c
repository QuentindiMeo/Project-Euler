...
int main(void)
{
    printf("Biggest horizontal: %i\n", horizontal());
    printf("Biggest vertical  : %i\n", vertical());
    printf("Biggest diagonal-l: %i\n", diagonal_l());
    printf("Biggest diagonal-r: %i\n", diagonal_r());
    return (SUCCESS);
/*    for (uint i = 0; i < 20; i++) {
        for (uint j = 0; j < 20; j++)
            printf("%c%d ", grid[i][j] < 10 ? '0' : '\0', grid[i][j]);
        printf("\n");
      }*/
}
